#!/usr/bin/env python3
"""
Option D: Hybrid Map - All visualization options combined
"""
...
print("🗺️  Building Option D: Hybrid Map...")
print("=" * 70)
...
print("\n🎯 Creating marker cluster layers...")

# Layer: Active Customer Clusters
active_cluster = MarkerCluster(name='🎯 Active Customer Clusters', show=False)
...
<div style="position: fixed; top: 10px; left: 50px; width: 650px; height: auto;
     ...
     <h4 style="margin:0; color:#333; font-size:16px;">Option D: Hybrid (All Options)</h4>
     <p style="margin:6px 0 0 0; font-size:13px; color:#666;">
     🔥 Heat Maps | 🎯 Clusters | 📊 Zip Aggregations - Toggle any combination!
     </p>
</div>
'''
...
# Save map
m.save('/workspace/option-d-hybrid.html')

print("\n✅ Option D: Hybrid Map created successfully!")
print(f"   Saved to: /workspace/option-d-hybrid.html")
print("=" * 70)
