#!/usr/bin/env python3
"""
Option C: Canvas Point Layer - All customers as tiny dots
"""

import folium
import pandas as pd

print("🗺️  Building Option C: Canvas Points Map...")
print("=" * 70)
...
# Active customer points layer
active_layer = folium.FeatureGroup(name='⚫ Active Customer Points', show=True)
...
print(f"   ✅ Active points: {len(df_active):,}")

# All customer points layer
all_layer = folium.FeatureGroup(name='⚫ All Customer Points', show=False)
...
<h4 style="margin:0; color:#333; font-size:16px;">Option C: Point Cloud</h4>
<p style="margin:6px 0 0 0; font-size:13px; color:#666;">Every customer shown as a tiny dot - zoom in to see density</p></div>'''
m.get_root().html.add_child(folium.Element(title_html))

m.save('/workspace/option-c-points.html')
print("✅ Option C: Canvas Points saved!")
